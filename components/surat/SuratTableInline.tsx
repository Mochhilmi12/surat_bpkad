          ...
          <Table className="min-w-[720px]">
            <TableHeader className="bg-[#F8F8FF]">
              <TableRow className="border-slate-200">
                <TableHead className="text-slate-700 font-semibold p-4 w-16">
                  #
                </TableHead>
                <TableHead className="text-slate-700 font-semibold p-4 w-40">
                  No Surat
                </TableHead>
                <TableHead className="text-slate-700 font-semibold p-4">
                  Perihal
                </TableHead>
                <TableHead className="text-slate-700 font-semibold p-4 w-64">
                  Tujuan
                </TableHead>
                <TableHead className="text-slate-700 font-semibold p-4 w-36">
                  Tanggal
                </TableHead>
                <TableHead className="text-slate-700 font-semibold p-4 w-28 text-center">
                  File
                </TableHead>
                      ...
                      {r.file_url ? (
                        <SuratFileSheet
                          ...
                          trigger={
                            <Button
                              variant="link"
                              className="p-0 h-auto text-[#27aae1]"
                            >
                              Lihat
                            </Button>
                          }
      ...
      <div className="w-full">
        ...
        <Dialog open={openArchive} onOpenChange={setOpenArchive}>
          <DialogContent>
            ...
            <p className="text-sm text-slate-600">
              Surat ini akan dipindahkan ke arsip bulanan. Anda tetap bisa
              melihatnya nanti.
            </p>
            <DialogFooter>
